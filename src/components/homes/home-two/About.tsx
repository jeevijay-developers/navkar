                  ...
                  <div className="row">
                     ...
                     <div className="col-xl-6 col-lg-6 mt-5 mt-lg-0">
                        <div className="about-content">
                           ...
                           <p className="mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".7s">{desc_1}</p>
                           <p className="mt-3 wow fadeInUp" data-wow-delay=".8s">{desc_2}</p>
                           ...
                           <div className="about-info-items">
                              <Link href="/about" className="theme-btn-2 wow fadeInUp" data-wow-delay=".5s">
                                 know More About us<span className="shape-img">
                                    <Image src={about_arrow2} alt="shape-img" />
                                 </span></Link>
                              <div className="call-area wow fadeInUp" data-wow-delay=".6s">
