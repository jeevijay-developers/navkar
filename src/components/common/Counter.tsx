...
import counter_thumb from "@/assets/img/01tp.png";
...
const Counter = ({ padding }: any) => {
  return (
    <section
      className={`Counter-section fix section-padding ${padding ? "" : "pt-0"}`}
    >
      <div className="container">
        <div className="counter-wrapper">
          <div
            className="industril-image text-center wow fadeInUp"
            data-wow-delay=".3s"
          >
            <Image
              src={counter_thumb}
          ...
          <div
            className="counter-main-items bg-cover"
